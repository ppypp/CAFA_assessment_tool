...
###############################################END OF RESULT ############################        
def getResults(method, onto, Type, mode, evaluation, results_folder):
    '''
    ...
    filename = os.path.join(results_folder,'{}_{}_{}_{}_{}_{}_results.txt'.format(onto, r.taxon, Type, mode, method, evaluation))
